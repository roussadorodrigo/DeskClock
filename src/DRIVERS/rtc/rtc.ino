/*********
  ...
  WiFi configurável via Serial Monitor
...
void setup() {
  ...
  // Solicitar credenciais WiFi via Serial
  getWiFiCredentials();
...
void getWiFiCredentials() {
  ...
  while (Serial.available() == 0) {
    delay(100); // Aguardar entrada do usuário
  }
  ssid = Serial.readStringUntil('\n');
  ssid.trim(); // Remove espaços e quebras de linha
  ...
  password.trim(); // Remove espaços e quebras de linha
